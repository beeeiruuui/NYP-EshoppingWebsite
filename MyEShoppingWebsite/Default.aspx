...
<body>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="ImgSlider/13.png" alt="Watch1" style="width: 100%;">
                    ...
                    <div class="item">
                        <img src="ImgSlider/1.png" alt="Watch2" style="width: 100%;">
                        <div class="carousel-caption">
                            <h3>
                    ...
                    <div class="item">
                        <img src="ImgSlider/Picture2.png" alt="Watch3" style="width: 100%;">
                        <div class="carousel-caption">
                            <h3>
    ...
    <div class="container center ">
        <div class="row ">
            <div class="col-lg-4">
                <img class="img-circle " src="Images/2.jpeg" alt="thumb" width="140" height="140" />
                <h2>
                    Coach</h2>
                <p>
                    Designed by Coach and manufactured by Movado Group, the Coach Watch Collection for men and women offers fashionable signature design and quality workmanship</p>
                <p>
            ...
            <div class="col-lg-4">
               <%-- <img class="img-circle " src="Images/Shoes.jpeg" alt="thumb" width="140" height="140" />--%>
                 <img class="img-circle " src="Images/11.jpg" alt="thumb" width="140" height="140" />
                <h2>
                    Casio</h2>
                <p>
                    To conclude, Casio watches are undoubtedly the best timepieces all over the globe due to their features, 
                    reliability, affordability, durability, and assistance
                     To conclude, Casio watches are undoubtedly the best timepieces all over the globe due to their features
            ...
            <div class="col-lg-4">
                ...
                <img class="img-circle " src="Images/1.jpeg" alt="thumb" width="140" height="140" />
                <h2>
                    Oscar de la Renta</h2>
                <p>
                   From Moulin Rouge! and Big Little Lies to the Mediterranean and Soho in the 70's, 
                    learn what Kate Spade New York, Oscar de la Renta, Christian Siriano, 
                    and more are inspired by this season.</p>
                <p>
                    <a class="btn btn-default " href="#" role="button">View More &raquo;</a></p>
            </div>
        </div>
        <div class="panel panel-primary">
            ...
            <div class="panel-footer">
                Buy 10 Shirts or Pants and get a gift card</div>
        </div>
    </div>
    </div>
    <!---Middle COntents End---->
    ...
    <footer>
            <div class ="container ">
                ...
                <p>&copy;2023 Coding.in &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="#">About</a>&middot;<a href ="#">Contact</a>&middot;<a href ="#">Products</a> </p>
            </div>
