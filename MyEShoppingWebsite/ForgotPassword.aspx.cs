    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyEShoppingDB2"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                MailMessage PassRecMail = new MailMessage("beeeiruuui@gmail.com", ToEmailAddress );
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("beeeiruuui@gmail.com", "waqmjwtqhowxsjty");
